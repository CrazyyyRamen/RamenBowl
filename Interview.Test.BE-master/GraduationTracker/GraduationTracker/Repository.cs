...
namespace GraduationTracker
{
    public class Repository
    {
        public static Student GetStudent(int id)
        {
            ...
            IGraduation<Student> obj = new Student();

            return obj.GetObjectByID(students, id);
        }
        ...
        public static Requirement GetRequirement(int id)
        {
            ...
            IGraduation<Requirement> obj = new Requirement();

            return obj.GetObjectByID(requirements, id);
        }
